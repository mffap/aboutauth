  ...
  const providers = [
    {
      ...
      github: "https://github.com/zitadel",
    ...
    },
    {
        ...
        github: "https://github.com/frontegg",
        description: "A self-hosted identity management platform that provides a comprehensive set of features including SSO, MFA, user management, and more. Frontegg is designed to be developer-friendly and easy to integrate into modern applications.",
        usp: "Developer-centric IAM with a focus on ease of integration and a rich feature set. Suitable for modern applications.",
        open_source: false,
        cloud_service: true,
        self_hosted: true,
    }
